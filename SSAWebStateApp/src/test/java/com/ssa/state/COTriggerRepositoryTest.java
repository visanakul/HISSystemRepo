...
@SpringBootTest
public class COTriggerRepositoryTest {
	...
	public void test2_getBucket0Triggers_repository() {
		long total = coTriggerRepository.findAllPendingTriggers(5, 0).size();
		assertEquals(809, total);
	}

	@Test@Ignore
	public void test3_getBucket1Triggers_repository() {
		long total = coTriggerRepository.findAllPendingTriggers(5, 1).size();
		assertEquals(829, total);
	}

	@Test@Ignore
	public void test4_getBucket2Triggers_repository() {
		long total = coTriggerRepository.findAllPendingTriggers(5, 2).size();
		assertEquals(842, total);
	}

	@Test@Ignore
	public void test5_getBucket3Triggers_repository() {
		long total = coTriggerRepository.findAllPendingTriggers(5, 3).size();
	...
	public void test6_getBucket4Triggers_repository() {
		long total = coTriggerRepository.findAllPendingTriggers(5, 4).size();
	...
	public void test7_getBucket5Triggers_repository() {
		long total = coTriggerRepository.findAllPendingTriggers(5, 5).size();
	...
	@Rollback(true)
	@Test
	public void test8_updateTriggerStatusCompleted_repository() {
		int num = coTriggerRepository.setTriggerStatusCompleted(100);
		assertEquals(1, num);
	}
}
